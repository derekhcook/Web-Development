...
document.addEventListener('DOMContentLoaded', function () {
   ...
   document.querySelector('#run-experiments').addEventListener('click', function () {
      ...
      // The Object.hasOwn function tells you whether a given object has a given property.
      outputString += "Object.hasOwn(obj1, 'artist'): " + Object.hasOwn(obj1, 'artist') + '\n';
      outputString += "Object.hasOwn(obj1, 'title'): " + Object.hasOwn(obj1, 'title') + '\n';
      outputString += '---\n';
      ...
      const findLetterCounts = function (inputString) {
         ...
         [...inputString].forEach(function (charValue) {
            ...
            if (/^[A-Z]$/.test(charValue)) {
               if (Object.hasOwn(letterCounts, charValue)) {
